...
async function loadRides() {
  ...
  try {
    ...
    const cards = rides.map(ride => {
      ...
      const priceValue = parseFloat(ride.price);
      const valorFormatado = priceValue.toFixed(2).replace('.', ',');
        ...
        <div class="ride-card bg-white rounded-2xl shadow-sm border border-gray-200 p-5 hover:shadow-md transition relative overflow-hidden"
          ...
          <div class="flex justify-between items-start mb-3 pl-2">
            ...
            <div class="text-right">
                <span class="block text-lg font-bold text-green-600">R$ ${valorFormatado}</span>
